...
function Initialize-BuildSpecifications {
    ...
    $patterns = @(
        ...
        "^sitecore-(xm1|xp)-sxa-(?!ps|def)-sqldev:(.*)$" # legacy\variants excluding publishing service
        "^sitecore-(xm1|xp)-sxa-(?!ps|def)-(standalone|cm|cd):(.*)$" # legacy\variants excluding publishing service
